...
public class ModContServiceImpl implements ModContService {
	...
	public ContMst modContStat(String contNo, String contStat) {
		...
		if("기간만료".equals(cm.getContStat())){
			throw new KakaoException(ErrCode.E1003.getErrMsg(), ErrCode.E1003);	//이미 계약기간이 만료된 계약입니다.
		}
		...
		if(compare >= 0) {
			...
			throw new KakaoException("이미 계약이 종료된 건입니다.", ErrCode.E1003);	
		}
